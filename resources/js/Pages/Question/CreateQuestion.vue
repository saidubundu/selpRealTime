        ...
        <main id="tt-pageContent">
            <div class="container">
                <div class="tt-wrapper-inner">
                    ...
                    <form class="form-default form-create-topic" @submit.prevent="handleSubmit">
...
<script>
    ...
    export default {
        ...
        methods:{
            handleSubmit(){
                this.$inertia.post('/question', this.form)
                .then(res => {
                    this.$toast.success('Topic Created successfully', "Success", {timeout: 3000});
                })
            }
        }
    }
