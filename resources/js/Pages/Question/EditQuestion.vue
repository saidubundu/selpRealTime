       ...
       <main id="tt-pageContent">
           <div class="container">
               <div class="tt-wrapper-inner">
                   ...
                   <form class="form-default form-create-topic" @submit.prevent="handleUpdate">
...
<script>
    ...
    export default {
        ...
        methods:{
            handleUpdate(){
                this.$inertia.patch(`/question/${this.question.slug}`, this.form)
                    .then(res => {
                        this.$toast.success('Topic Updated successfully!', "Success", {timeout: 3000});
                    })
            }
        }
    }
